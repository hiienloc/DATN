        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AvgDailySales = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    PredictQuantity = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    SuggestReStock = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PackageId = table.Column<int>(type: "int", nullable: false),
                    ProductId = table.Column<int>(type: "int", nullable: false),
                    PackageQty = table.Column<decimal>(type: "decimal(18,2)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReceiveName = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    ReceivePhone = table.Column<string>(type: "nvarchar(15)", maxLength: 15, nullable: false),
                    ReceiveAddress = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_InventoryTransactions_Packages_PackageId",
                        column: x => x.PackageId,
                        principalTable: "Packages",
                        principalColumn: "PackageId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryTransactions_PackageId",
                table: "InventoryTransactions",
                column: "PackageId");
